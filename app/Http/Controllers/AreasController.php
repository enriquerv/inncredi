...
use App\Http\Requests\AreasRequest as MasterRequest;
use App\Area as MasterModel;
use App\ViewArea as MasterViewModel;
use App\State;
use Sentinel;
use Redirect;
...
class AreasController extends Controller
{
    public function __construct() {
        ...
        $this->compact = ['word', 'word1', 'active', 'model', 'view', 'columns', 'select', 'actions', "model"];
