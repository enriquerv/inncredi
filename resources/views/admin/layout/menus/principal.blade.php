    ...
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            @if(Sentinel::getUser()->role_id <= 2)
                ...
                @php
                    $route_module = 'areas';
                    $route_title = trans('module_'.$route_module.'.module_title');
                    $route_title_plural = trans('module_'.$route_module.'.module_title_s');
            ...
            @endif
             ...
             @if(Sentinel::getUser()->role_id <= 2)
                {{-- Meetings --}}
                @php
                    $route_module = 'meetings';
                    $route_title = trans('module_'.$route_module.'.module_title');
                    $route_title_plural = trans('module_'.$route_module.'.module_title_s');
                    $route_font_awesome = 'file';
                ...
                <div class="collapse {{ $accordion }}" id="collapse{{ $route_module }}" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="{!! URL::route($route_module) !!}">{{ trans('strings.crud.list_of') }} {{ $route_title }}</a>
                    <a class="nav-link" href="{!! URL::route($route_module.'.create') !!}">{{ trans('strings.crud.add') }} {{ $route_title_plural }}</a>
                    <a class="nav-link" href="{!! URL::route($route_module.'.deleted') !!}">{{ trans('strings.crud.restore') }} {{ $route_title }}</a>
                  </nav>
                </div>
            @endif
