...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        "notes"                                 => "Notas",
        "input_select"                          => "Selecciona...",
        "input_select_client"                   => "Selecciona un cliente...",
        "requirement_name"                      => "Nombre requerimiento",
        "development_id"                        => "ID Requerimiento Asociado",
        "process_flow"                          => "Proceso / Flujo",
        "contact_rak"                           => "Contacto Fábrica RAK",
        "contact_client"                        => "Contacto Cliente",
        "involved_people"                       => "Involucrados",
        "description_requirement"               => "Descripción breve del requerimiento",
        "description_background"                => "Antecedentes de este requerimiento",
        "general_docs"                          => "Documentos generales necesarios para el requerimiento (Formatos, procedimientos, reportes, etc)",
        "frontend_function"                     => "Funcionalidad o cambios en Front End (Interfaz de Usuario)",
        "backoffice_changes"                    => "Cambios en Back Office:",
        "testing_plan_client"                   => "Plan de testing del Cliente",
        "req_risk_matriz"                       => "Matríz de riesgos e impactos de implementación de este requerimiento",
        "bussiness_flow_diagram"                => "Diagrama de flujo del negocio",
        "flow_diagram"                          => "Diagrama de flujo del Sitio/Sistema",
        "authorize_rak"                         => "Autoriza Fábrica de Soluciones RAK",
        "authorize_client"                      => "Autoriza Cliente",

        "interview_name"                        => "Nombre entrevista",
        "questions"                             => "Preguntas",
        "ref_imgs"                              => "Imágenes de referencia",
        ...
        'person_email'                               => 'Email del contacto',
        'person_position'                               => 'Posición del contacto',
        'purchase_model'                               => 'Modelo de compra',
        'product'                               => 'Producto',
        'product_cost'                               => 'Costo por producto',
    ],
